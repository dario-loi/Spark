...
public:
	...
	void setInstanceSubData(std::vector<spark::SparkInstanceData> const& data, size_t offset) const noexcept;
	void setInstanceData(std::vector<spark::SparkInstanceData> const& data) const noexcept;
